...
function testCompositeCreated() {
    ...
    if ! assertCurl 200 "curl https://$HOST:$PORT/product-composite/$PROD_ID_REVS_RECS -s" "test composite curl"
    then
        echo -n "FAIL"
        return 1
    fi
...
assertCurl 200 "curl https://$HOST:$PORT/product-composite/$PROD_ID_REVS_RECS -s" "curl test"
